    ...
    <div className="p-6 mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
        ...
        <div className="flex flex-col items-center text-center space-y-4 relative">
          <h1 className="text-3xl font-bold text-update">Contact Us</h1>
          <img
            className="w-60 h-60 object-contain"
            src="/assets/svg/contact.svg"
            alt="muthukumaran r portfolio contact"
          />
        ...
        <form className="flex flex-col space-y-4">
          <div>
            <label htmlFor="name" className="text-update text-lg">
              Name
            </label>
            <input
              type="text"
        ...
        <div className="space-y-6 text-white">
          <div className="flex items-start space-x-3">
            <FaHome className="text-2xl text-beige" />
            <div>
              <h3 className="text-foreground font-semibold">Address</h3>
              <p className="text-foreground/70">
                136/2 Nadar street, Sirumalanchi, Tirunelveli, Tamilnadu - 627103
              </p>
            </div>
          </div>

          <div className="flex items-start space-x-3">
            <FaPhoneAlt className="text-2xl text-beige" />
            <div>
              <h3 className="text-foreground font-semibold">Phone</h3>
              <a href="tel:+919543439311" className="text-foreground/70">
                +91 9543439311
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            <MdEmail className="text-2xl text-beige" />
            <div>
              <h3 className="text-foreground font-semibold">Email</h3>
              <a href="mailto:kumaranraja222@gmail.com" className="text-foreground/70">
                kumaranraja222@gmail.com
              </a>
            </div>
          </div>
