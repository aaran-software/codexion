...
import { PrintAddress, PrintBank, PrintInvoiceInfo } from '../../../resources/layouts/printformat/PrintFormat2';
...
function PrintFooter({ bank, totalAmount, cgst, sgst, totalGST, roundedTotal, grandTotalInWords, client,invoiceInfo }:PrintFooterProps) {
  return (
    <div>
