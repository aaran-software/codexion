...
import { PrintAddress, PrintBank, PrintCustomerAddress, PrintInvoiceInfo } from '../../../resources/layouts/printformat/PrintFormat2';
...
function PrintHeader({ client, logo, invoiceInfo, customerName, BillAddress, ShipingAddress }:PrintHeaderProps) {
  return (
    <div>
