...
export default function DocViewer({slug}: DocViewerProps) {
    ...
    const markdownComponents: Components = {
        ...
        li({children, checked, ...props}: any) {
            ...
            return <li className="ml-6 mb-2 list-disc" {...props}>{children}</li>;
        },

        // Tables
        table({children, ...props}) {
            return (
                <table className="table-auto border border-gray-300 w-full my-4" {...props}>
                    {children}
                </table>
            );
        },
        ...
        h3({children, ...props}) {
            return <h3 className="text-xl font-semibold my-2" {...props}>{children}</h3>;
        },
        h4({children, ...props}) {
            return <h4 className="text-lg font-semibold my-2" {...props}>{children}</h4>;
        },
        h5({children, ...props}) {
            return <h5 className="text-base font-semibold my-1" {...props}>{children}</h5>;
        },
        h6({children, ...props}) {
            return <h6 className="text-base font-medium my-1" {...props}>{children}</h6>;
        },
        ...
        img({src, alt, ...props}: { src?: string; alt?: string }) {
            return <img src={src} alt={alt} className="max-w-full my-2 rounded" {...props} />;
        },
    };
