...
const Home: React.FC = () => {
    ...
    const portfolio = ['/assets/sample1.jpg', '/assets/sample2.jpg', '/assets/sample4.jpg', '/assets/sample1.jpg', '/assets/sample2.jpg', '/assets/sample4.jpg']
            ...
            <section id='home' className='pt-20'>
                ...
                <div className='px-5 lg:px-[12%] grid lg:grid-cols-2 gap-15 py-20'>
                    ...
                    <div className='flex flex-col  justify-center gap-8'>
                        <h1 className='text-xl md:text-3xl lg:text-4xl font-bold'>Leading ERP Solution Provider in
                            India</h1>
                        <p>At LogicX, we specialize in ERP implementation, customization, and ongoing support for small
                            to medium businesses across India. Whether you run a manufacturing unit, textile business,
                            retail shop, or service-based company, our tailored ERP solutions help streamline
                            operations, reduce manual errors, and improve decision-making.</p>
                        <p>Our certified developers and domain experts ensure seamless integration with tools like
                            Tally, Woo Commerce, and payment gateways. We offer cloud hosting, server setup, data
                            migration, and training for your team—so you can focus on growth, not on systems.</p>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-3 pt-5 bg-website-background text-website-foreground'>
                    <h1 className='text-2xl text-center md:text-3xl lg:text-4xl font-bold p-5'>Our ERP Success
                        Stories</h1>
                    <p className='text-center p-5 lg:px-[12%]'>From textile manufacturers to retail chains and IT
                        service providers, LogicX has delivered tailored ERP solutions that transform operations. With
                        20+ years of experience, we help Indian SMEs automate workflows, improve visibility, and scale
                        with confidence.</p>
                    <div className='grid grid-cols-2 md:grid-cols-3 mt-20'>
                        {
                            portfolio.map((img, idx) => (
                                <img key={idx} src={img} onClick={() => {
                            ...
                            <Carousel autoSlide={true} startIndex={selectedIndex} autoSlideInterval={7000}>
                                {
                                    portfolio.map((img, idx) => (
                                        <img key={idx} src={img}
                                             onClick={() => setSliderVisible((sliderVisible) => !sliderVisible)}
                                             alt=''/>
                                    ))
                                }
                            </Carousel>
                ...
                <div className='px-5 lg:px-[12%] py-10 flex flex-col sm:flex-row justify-between  bg-[#128d57]'>
                    <div className='sm:w-3/5 px-5'>
                        <h1 className='text-2xl text-gray-50 my-5 font-semibold'>Start your ERP journey with a free
